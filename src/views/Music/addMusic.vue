          ...
          <div class="info_item">
            <label for>歌手：</label>
             <Form-item prop="musicsinger">
              <i-select v-model="formInline.musicsinger" style="width:200px">
                <i-option
          ...
          <div class="info_item">
            ...
            <Form-item prop="musicimg">
              ...
              <div class="demo-upload-list" v-else>
               ...
               <Modal v-model="visible" title="查看图片" @on-cancel="cancel">
  ...
  methods: {
    ...
    getSinger(){
      this.axios
        ...
        .then(resp => {
          if (resp.status == 200) {
         this.singerList=resp.data.data.map(item=>{
